...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BLUE}🚀 Starting Windows Release Process (${VERSION_TYPE} bump)${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
# Step 7: Build
echo -e "${YELLOW}🔨 Building Windows production artifacts...${NC}"
...
BUNDLE_DIR="./packages/desktop/src-tauri/target/x86_64-pc-windows-msvc/release/bundle"
ARTIFACT_PATTERNS=(
  ...
  "$BUNDLE_DIR/portable/*${NEW_VERSION}*.exe"
)
...
echo -e "${YELLOW}🧾 Generating latest.json (Windows)...${NC}"
