...
- Use English for all user-facing UI copy, logs, test titles/assertions, and code comments.
- Do not introduce new Chinese text in source files unless explicitly requested for localization work.
